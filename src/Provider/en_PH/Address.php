...
class Address extends \Faker\Provider\en_US\Address
{
    ...
    protected static $barangay = [
        'Poblacion', 'Acacia', 'Addition Hills', 'Aguho', 'Alabang', 'Alicia', 'Almanza Uno', 'Almanza Dos', 'Amihan', 'Amparo', 'Apolonio Samson', 'Arkong Bato', 'Aurora', 'Ayala Alabang', 'Baclaran', 'Baesa', 'Bagbag', 'Bagbaguin', 'Bagong Barrio', 'Bagong Ilog', 'Bagong Katipunan', 'Bagong Lipunan ng Crame', 'Bagong Pag-asa', 'Bagong Silang', 'Bagong Silangan', 'Bagumbayan', 'Bagumbayan North', 'Bagumbayan South', 'Bagumbong', 'Bagumbuhay', 'Bahay Toro', 'Balangkas-Caloong', 'Balingasa', 'Balintawak', 'Balong Bato', 'Balong-bato', 'Bambang', 'Bangkal', 'Bangkulasi', 'Barangka', 'Barangka Drive', 'Barangka Ibaba', 'Barangka Ilaya', 'Barangka Itaas', 'Baritan', 'Barrio San Jose', 'Batasan Hills', 'Batis', 'Bayanan', 'Bayanihan', 'Bayan-bayanan', 'Bel-Air', 'BF Homes Caloocan', 'BF Homes', 'BF International Village-CAA', 'Biglang-Awa', 'Bignay', 'Binondo', 'Bisig', 'Blue Ridge A', 'Blue Ridge B', 'Botocan', 'Buayang Bato', 'Buli', 'Bungad', 'Burol', 'Buting', 'Poblacion', 'Calumpang', 'Calzada', 'Camarin', 'Camarin-Central', 'Camarin-Cielito', 'Camarin-Kiko', 'Camp Aguinaldo', 'Caniogan', 'Canumay East', 'Canumay West', 'Capri', 'Carmona', 'Catmon', 'Caybiga', 'Cembo', 'Central', 'Central Bicutan', 'Central Signal Village', 'Claro', 'Coloong', 'Comembo', 'Commonwealth', 'Concepcion', 'Concepcion Uno', 'Concepcion Dos', 'Congress Village', 'Corazon de Jesus', 'Culiat', 'Cupang', 'Daang Bakal', 'Daanghari', 'Dagat-Dagatan', 'Dalandanan', 'Damar', 'Damayan', 'Damayang Lagi', 'Dampalit', 'Daniel Fajardo', 'Dasmariñas', 'Del Monte', 'Dela Paz', 'Deparo', 'Deparo II', 'Dioquino Zobel', 'District 1', 'District 2', 'Don Bosco', 'Don Galo', 'Don Manuel', 'Doña Aurora', 'Doña Imelda', 'Doña Josefa', 'Duyan Duyan', 'East Kamias', 'East Rembo', 'Elias Aldana', 'Ermita', 'Ermitaño', 'Escopa I', 'Escopa II', 'Escopa III', 'Escopa IV', 'E. Rodriguez', 'Fairview', 'Flores', 'Forbes Park', 'Fort Bonifacio', 'Fortune', 'General T. de Leon', 'Grace Park East', 'Grace Park West', 'Greater Lagro', 'Greenhills', 'Guadalupe Nuevo', 'Guadalupe Viejo', 'Gulod', 'Hagdang Bato Itaas', 'Hagdang Bato Libis', 'Hagonoy', 'Harapin ang Bukas', 'Heroes del 96', 'Highway Hills', 'Horseshoe', 'Holy Spirit', 'Hulo', 'Hulong Duhat', 'Ibaba', 'Ibayo Tipas', 'Ilaya', 'Immaculate Concepcion', 'Industrial Valley', 'Intramuros', 'Isabelita', 'Isla', 'Jesus de la Peña', 'Kabayanan', 'Kalawaan', 'Kaligayahan', 'Kalusugan', 'Kamuning', 'Kapasigan', 'Kapitolyo', 'Karuhatan', 'Kasilawan', 'Katipunan', 'Katuparan', 'Kaunlaran', 'Kaunlaran Village', 'Kristong Hari', 'Krus na Ligas', 'La Huerta', 'La Paz', 'Laging Handa', 'Lawang Bato', 'Libis', 'Libis Baesa', 'Libis Reparo', 'Ligid Tipas', 'Lingunan', 'Little Baguio', 'Llano', 'Longos', 'Lourdes', 'Lower Bicutan', 'Loyola Heights', 'Mabini-J. Rizal', 'Mabolo', 'Magallanes', 'Magtanggol', 'Maharlika', 'Maharlika Village', 'Malamig', 'Malanday', 'Malaria', 'Malate', 'Malaya', 'Malinao', 'Malinta', 'Mangga', 'Manggahan', 'Manresa', 'Manuyo Uno', 'Manuyo Dos', 'Mapulang Lupa', 'Marcelo Green', 'Mariana', 'Mariblo', 'Marikina Heights', 'Marilag', 'Martires', 'Marulas', 'Masagana', 'Masambong', 'Matandang Balara', 'Mauway', 'Maybunga', 'Maypajo', 'Maysan', 'Maysilo', 'Maytunas', 'Merville', 'Milagrosa', 'Monumento', 'Moonwalk', 'Morning Breeze', 'Muzon', 'Nagkaisang Nayon', 'Namayan', 'Nangka', 'Napindan', 'Navotas East', 'Navotas West', 'Nayong Kanluran', 'New Era', 'New Lower Bicutan', 'New Zañiga', 'Niugan', 'North Daang Hari', 'North Fairview', 'North Signal Village', 'Northbay Boulevard North', 'Novaliches Proper', 'N.S. Amoranto', 'Obrero', 'Old Capitol Site', 'Old Zañiga', 'Olympia', 'Onse', 'Oranbo', 'Paang Bundok', 'Paco', 'Pag-asa', 'Pag-ibig sa Nayon', 'Palanan', 'Palasan', 'Palatiw', 'Paligsahan', 'Palingon', 'Paltok', 'Pamplona Uno', 'Pamplona Dos', 'Pamplona Tres', 'Pandacan', 'Pangarap Village', 'Panghulo', 'Pansol', 'Parada', 'Paraiso', 'Parang', 'Pariancillo Villa', 'Pasadeña', 'Paso de Blas', 'Pasolo', 'Pasong Putik', 'Pasong Tamo', 'Payatas', 'Pedro Cruz', 'Pembo', 'Phil-Am', 'Pilar Village', 'Pinagbuhatan', 'Pinagkaisahan', 'Pinagsama', 'Pineda', 'Pinyahan', 'Pio del Pilar', 'Pitogo', 'Plainview', 'Pleasant Hills', 'Polo', 'Port Area', 'Post Proper Northside', 'Post Proper Southside', 'Potrero', 'Progreso', 'Project 6', 'Pulang Lupa Uno', 'Pulang Lupa Dos', 'Punturin', 'Putatan', 'Quiapo', 'Quirino 2-A', 'Quirino 2-B', 'Quirino 2-C', 'Quirino 3-A', 'Ramon Magsaysay', 'Rincon', 'Rivera', 'Rizal', 'Rosario', 'Roxas', 'Sacred Heart', 'Sagad', 'Salapan', 'Salvacion', 'Sampaloc', 'San Agustin', 'San Andres', 'San Antonio', 'San Bartolome', 'San Dionisio', 'San Isidro', 'San Isidro Labrador', 'San Joaquin', 'San Jose', 'San Lorenzo', 'San Martin de Porres', 'San Miguel', 'San Miguel', 'San Nicolas', 'San Nicolas', 'San Pedro', 'San Perfecto', 'San Rafael Village', 'San Roque', 'San Vicente', 'Sangandaan', 'Santa Ana', 'Santa Ana', 'Santa Cruz', 'Santa Cruz', 'Santa Elena', 'Santa Lucia', 'Santa Mesa', 'Santa Monica', 'Santa Quiteria', 'Santa Rosa', 'Santa Teresita', 'Santo Cristo', 'Santo Domingo', 'Santo Niño', 'Santo Rosario Kanluran', 'Santo Rosario Silangan', 'Santo Tomas', 'Santol', 'Santolan', 'Sauyo', 'Siena', 'Sikatuna Village', 'Silangan', 'Singkamas', 'Sipac-Almacen', 'Socorro', 'South Cembo', 'South Daang Hari', 'South Signal Village', 'South Triangle', 'St. Ignatius', 'St. Joseph', 'St. Peter', 'Sucat', 'Sumilang', 'Sun Valley', 'Tabacalera', 'Tagalag', 'Tagumpay', 'Tala', 'Talayan', 'Talipapa', 'Talon Uno', 'Talon Dos', 'Talon Tres', 'Talon Cuatro', 'Talon Singko', 'Tambo', 'Tandang Sora', 'Tangos North', 'Tangos South', 'Tanyag', 'Tanza 1', 'Tanza 2', 'Tañong', 'Tatalon', 'Teacher\'s Village East', 'Teacher\'s Village West', 'Tejeros', 'Tibagan', 'Tinajeros', 'Tondo', 'Tonsuya', 'Tugatog', 'Tuktukan', 'Tumana', 'Tunasan', 'Ugong', 'Ugong Norte', 'Unang Sigaw', 'University Hills', 'UP Campus', 'UP Village', 'Upper Bicutan', 'Urdaneta', 'Urduja Village', 'Ususan', 'Valencia', 'Valenzuela', 'Vasra', 'Veinte Reales', 'Vergara', 'Veterans Village', 'Villa Maria Clara', 'Vitalez', 'Wack-Wack Greenhills', 'Wawa', 'Wawang Pulo', 'West Crame', 'West Kamias', 'West Rembo', 'West Triangle', 'Western Bicutan', 'White Plains', 'Zapote',
    ];
